...
# I can also use pickle to save the best fitted data.
WIN_WIDTH=570
WIN_HEIGHT=800
GEN=0
...
class Pipe:
    ...
    def collide(self,bird,win):
        ...
        bootom_offset=(self.x-bird.x,self.bottom-round(bird.y))

        bottom_point=bird_mask.overlap(bottom_mask,bootom_offset)
